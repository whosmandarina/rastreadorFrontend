...
const NAV_ITEMS = [
  { label: 'Dashboard',    icon: '🗺',  route: '/(web)/dashboard',   roles: ['ADMIN', 'SUPERVISOR', 'CLIENT'] },
  { label: 'Usuarios',     icon: '👥',  route: '/(web)/users',        roles: ['ADMIN', 'SUPERVISOR'] },
  { label: 'Clientes',     icon: '🏢',  route: '/(web)/clients',      roles: ['ADMIN'] },
  { label: 'Asignaciones', icon: '🔗',  route: '/(web)/assignments',  roles: ['ADMIN'] },
  { label: 'Geocercas',    icon: '📍',  route: '/(web)/geofences',    roles: ['ADMIN', 'SUPERVISOR'] },
  { label: 'Reportes',     icon: '📊',  route: '/(web)/reports',      roles: ['ADMIN', 'SUPERVISOR', 'CLIENT'] },
  { label: 'Alertas',      icon: '🔔',  route: '/(web)/alerts',       roles: ['ADMIN', 'SUPERVISOR'] },
  { label: 'Mi Perfil',    icon: '👤',  route: '/(web)/profile',      roles: ['ADMIN', 'SUPERVISOR', 'CLIENT'] },
];
...
const styles = StyleSheet.create({
  ...
  // User section
  userSection: {
    borderTopWidth: 1, borderTopColor: '#0a2d42',
    paddingTop: 12, paddingBottom: 24, gap: 10,
  },
