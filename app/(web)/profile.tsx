      ...
      <View style={styles.body}>
        ...
        <View style={styles.avatarCard}>
          ...
          <View style={[styles.roleBadge, { backgroundColor: roleCfg.color + '20', borderColor: roleCfg.color + '40' }]}>
            <Ionicons name={roleCfg.icon as any} size={14} color={roleCfg.color} style={{ marginRight: 4 }} />
          ...
          {editing && (
            <View style={styles.actions}>
              <TouchableOpacity
                ...
                onPress={() => { setEditing(false); setForm({ nombre: user?.nombre ?? '', telefono: '' }); }}
              >
...
const styles = StyleSheet.create({
  ...
  // Avatar card
  avatarCard: {
    width: 240, backgroundColor: COLORS.bgCard, borderRadius: 16,
  ...
  logoutBtn: {
    marginTop: 8, width: '100%', backgroundColor: COLORS.danger + '15',
  ...
  // Info card
  infoCard: {
    flex: 1, minWidth: 300, backgroundColor: COLORS.bgCard,
  ...
  editBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: COLORS.bgInput, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 7, borderWidth: 1, borderColor: COLORS.border },
  ...
  input: {
    backgroundColor: COLORS.bgInput, borderWidth: 1, borderColor: COLORS.primary + '60',
