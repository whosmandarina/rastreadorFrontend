...
import {
  useTrackingStore,
  TrackingStatus,
} from '../../src/stores/tracking.store';
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TouchableOpacity
        style={[
          styles.trackBtn,
          isTracking ? styles.trackBtnStop : styles.trackBtnStart,
        ]}
      ...
      <View style={styles.grid}>
        <StatCard
          ...
          color={
            battery !== null && battery <= 15 ? COLORS.accent : COLORS.success
          }
        />
        <StatCard
        ...
        <StatCard
          ...
          value={
            currentLocation
              ? `${currentLocation.latitud.toFixed(4)}, ${currentLocation.longitud.toFixed(4)}`
              : '—'
          }
          ...
          <View style={styles.offlineLeft}>
            ...
            <View>
              <Text style={styles.offlineTitle}>
                {pendingCount} ubicaciones pendientes
              </Text>
      ...
      {!hasConsent && (
        ...
        >
          <Text style={styles.consentText}>
            ⚠️ Necesitas aceptar el consentimiento para activar el rastreo
          </Text>
        </TouchableOpacity>
      )}
    </ScrollView>
...
function StatCard({ icon, label, value, color, small }: any) {
  return (
    <View style={[styles.statCard, small && styles.statCardWide]}>
      ...
      <Text style={[styles.statValue, { color, fontSize: small ? 12 : 18 }]}>
        {value}
      </Text>
